package com.google.firebase.quickstart.auth.abworddictionery
...
import com.google.firebase.quickstart.auth.abworddictionery.databinding.FragmentLetterListBinding
...
class LetterListFragment : Fragment() {
    ...
    private fun setIcon(menuItem: MenuItem?) {
        ...
        menuItem.icon =
            if (isLinearLayoutManager)
                ContextCompat.getDrawable(this.requireContext(), R.drawable.ic_baseline_linear_scale_24)
